...
There is a [web version](https://crudekings.kyzen7.dev/) of this application being developed by [kyzen](https://github.com/kyzenlabs) you can use if you wish. Thanks for saving me from more frontend design and conversion ♥️.
